...
const AdminTemplate: React.FC<AdminTemplateProps> = ({ data }) => {
  return (
    <div style={{ background: 'linear-gradient(135deg, #f6ffed 0%, #d9f7be 100%)', borderRadius: 16, boxShadow: '0 4px 24px rgba(82, 196, 26, 0.08)', padding: 32 }}>
      {/* En-tête */}
      <Row gutter={24} align="middle" style={{ marginBottom: 32 }}>
        ...
        <Col xs={24} md={17}>
          <div style={{ display: 'flex', flexWrap: 'wrap', gap: 16 }}>
            ...
            <Tag color="lime"><PhoneOutlined /> {data.personalInfo.phone}</Tag>
            <Tag color="gold"><EnvironmentOutlined /> {data.personalInfo.address}</Tag>
      ...
      <section style={{ marginBottom: 32 }}>
        <Title level={4} style={{ color: '#52c41a' }}><SolutionOutlined /> Expérience Administration / RH</Title>
        <Timeline>
