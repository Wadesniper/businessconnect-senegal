...
const HumanTemplate: React.FC<HumanTemplateProps> = ({ data }) => {
  return (
    <div style={{ background: 'linear-gradient(135deg, #e6f7ff 0%, #fff0f6 100%)', borderRadius: 16, boxShadow: '0 4px 24px rgba(255, 77, 153, 0.08)', padding: 32 }}>
      {/* En-tête */}
      ...
      <section style={{ marginBottom: 32 }}>
        <Title level={4} style={{ color: '#2f54eb' }}><HeartOutlined /> Expérience Humanitaire / Social</Title>
        <Timeline>
        ...
        <Row gutter={[16, 16]}>
          {data.skills.map((skill, idx) => (
            <Col xs={24} sm={12} md={8} key={idx}>
              <Card style={{ background: '#e6f7ff', border: '1px solid #adc6ff' }}>
