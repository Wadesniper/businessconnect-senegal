...
const MarketingTemplate: React.FC<MarketingTemplateProps> = ({ data }) => {
  return (
    <div style={{ background: 'linear-gradient(135deg, #fffbe6 0%, #ffe7ba 100%)', borderRadius: 16, boxShadow: '0 4px 24px rgba(255, 193, 7, 0.08)', padding: 32 }}>
      ...
      <section style={{ marginBottom: 32 }}>
        <Title level={4} style={{ color: '#fa8c16' }}><BulbOutlined /> Expérience Marketing</Title>
        <Timeline>
      ...
      {/* Compétences */}
      <section style={{ marginBottom: 32 }}>
        <Title level={4} style={{ color: '#fa8c16' }}>Compétences Clés</Title>
        <Row gutter={[16, 16]}>
      ...
      {/* Formation */}
      <section style={{ marginBottom: 32 }}>
        <Title level={4} style={{ color: '#fa8c16' }}>Formation</Title>
        <Timeline>
      ...
      {data.certifications && data.certifications.length > 0 && (
        <section style={{ marginBottom: 32 }}>
          <Title level={4} style={{ color: '#fa8c16' }}>Certifications</Title>
          <Row gutter={[16, 16]}>
      ...
      {/* Langues */}
      <section>
        <Title level={4} style={{ color: '#fa8c16' }}>Langues</Title>
        <Row gutter={[16, 16]}>
