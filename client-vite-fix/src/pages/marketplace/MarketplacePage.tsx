...
const MarketplacePage: React.FC = () => {
  ...
  useEffect(() => {
    console.log('[DEBUG][MarketplacePage] user:', user);
    console.log('[DEBUG][MarketplacePage] items:', items);
  }, [user, items]);
      ...
      <Layout.Content>
        <Row gutter={[24, 24]}>
          ...
          {items.map(item => {
            ...
            console.log('[DEBUG][MarketplacePage] item:', item, 'isOwner:', isOwner, 'isAdmin:', isAdmin);
            return (
