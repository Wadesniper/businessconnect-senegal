        ...
        <TextContent>
          ...
          >
            <Title style={{ color: 'white', fontSize: '48px', marginBottom: '20px' }}>
              La <GreenSpan>plateforme n°1</GreenSpan> <span style={{color:'yellow',fontWeight:900}}>TEST VERCEL</span> où les <GreenSpan>talents</GreenSpan> <span style={{color:'white', fontWeight:700}}>sénégalais</span> rencontrent les <GreenSpan>opportunités</GreenSpan>
            </Title>
